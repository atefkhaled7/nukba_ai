...
const plans = [
  {
    name: "Basic",
    price: "499",
    description: "الحل الأمثل لتغطية الأسئلة المتكررة وتوفير الوقت.",
    features: [
  ...
  },
  {
    name: "Standard",
    price: "999",
    description: "لنمو أعمالك: شات بوت يتعلم عن عملائك ويزيد كفاءتك.",
    features: [
      "عربي + إنجليزي",
      "يفهم الفويس نوت (Voice Notes)",
      "Memory أساسية (اسم + رقم + آخر طلب + حفظ عنوان التوصيل)",
      "3000 رسالة شهريًا",
  ...
  },
  {
    name: "Premium",
    price: "1999",
    description: "الأتمتة الكاملة: تحويل خدمة العملاء إلى مركز ربح متكامل.",
    features: [
